...
parameters {
  ...
  simplex[N_buildingTypes] buildingTypeProbs[N_cities]; //vector[N_buildingTypes] raw_logits[N_cities, N_zones];
...
model {
  ...
  for (c in 1:N_cities){
    buildingtype_counts[c] ~ multinomial(buildingTypeProbs[c]);
  }
