...
parameters {
  ...
  real<lower=0> frag_adj_survey[N_buildingTypes];
...
transformed parameters {
  ...
  for (n in 1:N_buildings)
    damage_probs[n] = lognormal_cdf(PGV[n], mu[buildingTypes[n]] + eps_city_errors[cities[n]] - frag_adj_survey[buildingTypes[n]], sigma[buildingTypes[n]]);
